...
async function start() {
   try {
      ...
      global.redexLoggerLevel = that.redexConfig.loggerLevel || 'debug';
      ...
      global.redex = that.redex = new Redex(that.redexConfig);
      that.redex.startTime = new Date().getTime();
      RedexConfigs.createProcessors(redex, that.redexConfig.configs);
