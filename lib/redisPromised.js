...
// https://github.com/evanx/redexrouter/blob/master/lib/redisPromisified.js

import redis from 'redis';
import bunyan from 'bunyan';
import lodash from 'lodash';

const logger = bunyan.createLogger({name: 'Redis', level: global.redexLoggerLevel});
...
// see test: https://github.com/evanx/redexrouter/blob/master/test/redisPromised.js
